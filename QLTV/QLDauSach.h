...
//void xoaDMS(int ma)
//{
//	gotoxy(0,yNhap); cout << "Nhap ma sach muon xoa:";
//	fflush(stdin);
//	int ma_sach = NhapMaSach(23,yNhap, ma_sach);      
//		
//	PTR_DMS p = Mang_DS.ds[ma]->dms;
//	while (p!=NULL)
//	{
//		if (p->data.masach == ma_sach)
//		{				
//			if(p->data.trangthai == 1 || Mang_DS.ds[ma]->luotmuon > 0) 
//			{
//				ThongBao("Khong xoa dc!"); 
//				return;
//			}
//			else
//			{
//				gotoxy(0,yNhap+2);	cout << "Nhap lai ma sach muon xoa:";
//				int ms = NhapSo(27,yNhap+2, ms);
//				
//				
//				
//				if(ms == ma_sach)
//				{	
//					PTR_DMS q = new node_dms;
//					q->next = p;
//					q->next->next = p->next;	 																							
//					delete p;					
//					Mang_DS.ds[ma]->nDMS--;
//					ThongBao("Xoa sach thanh cong");
//					return;
//				}
//				else 
//				{
